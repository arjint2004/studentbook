												...
												success: function(msg) {
													$("#wait").remove();	
														$.ajax({
															...
															<? if(empty($psikomotorik)){?>
															url: '<?=base_url('akademik/instrumen/sukses/RPP')?>',
															<? }else{ ?>
															url: '<?=base_url('akademik/instrumen/sukses/PSIKOMOTORIK')?>',
															<? } ?>
															beforeSend: function() {
								...
								<form action="<?=base_url()?>akademik/instrumen/psikomotorik" method="post" id="catatangurudataform" style="width:700px;height:100%;">
								<table>
									<tbody>
										<tr>
											<td>
