				...
				$.ajax({
					...
					success: function(msg) {
						...
						$.ajax({
							...
							url: '<?=base_url('akademik/perencanaan/kognitif/'.$id_pembelajaran.'')?>',
							beforeSend: function() {
								$("#simpanpr").after("<img id='wait' style='margin:0;float:right;'  src='<?=$this->config->item('images').'loading.png';?>' />");
							},
							success: function(msg) {
...
<form method="post" name="materi" enctype="multipart/form-data" id="materirpp"  style="width:700px;" action="<? echo base_url();?>akademik/perencanaan/materi">
