					...
					<ul class="side-nav">						
                    	...
                    	<li <? if($this->router->class=='penghubungortutk' && $this->router->method=='addcontent'){echo 'class="current_page_item"';}?>> <a href="<?=site_url()?>admin/penghubungortutk/addcontent" title=""> Setting Laporan Penilaian 1<span> </span> </a> </li>
                    	<li <? if($this->router->class=='penghubungortutk' && $this->router->method=='addcontenttpa'){echo 'class="current_page_item"';}?>> <a href="<?=site_url()?>admin/penghubungortutk/addcontenttpa" title=""> Setting Laporan Penilaian 2<span> </span> </a> </li>
