<?php $this->load->view('sosial/function'); ?>
...
<div class="tabs-container">
    ...
    <div class="tabs-frame-content" style="display: block;background: #f2f2f2;">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="block messaging blok_message scrollbar" id="style-6">
                                    ...
                                    <?php if(!empty($status_siswa)) {
                                        foreach($status_siswa['status'] as $stat_item){
                                                        ...
                                                        <div class="span10">
                                                            <form method="POST" id="komentar" action="<?=site_url('sos/siswa/set_komentar')?>">
                                                                <div class="itemOut">
                                                                    <div class="controls">
                                                                        <div class="control">
                                                                            <textarea name="komentar" class="komentar_teks" placeholder="Komentar anda <?=(!empty($siswa->nama) ? $siswa->nama : '')?>" style="height: 50px; width: 100%;background: white;"></textarea>
    ...
    <div class="tabs-frame-content" style="display: none;">
        ...
        <div class="row-fluid">
            <?php   
                if(!empty($teman)) {
                    echo '<div class="scrollbar_upload span12" id="style-6" style="height:auto;">';
                    echo '<div class="status_style">
                                <div class="workplace">
                                    <div class="head clearfix">
                                        <div class="isw-users"></div>
                    ...
                    foreach($teman as $tmn) {
                        if($no==0){
                            echo '<div class="span12 teman" style="margin:7px;margin-left:0px;">';
                        }
                        if(empty($tmn->images)) {
                        ...
                        ?>
                            <div class="span4 datalist_user no_margin">
                                ...
                                <div class="span8 left">
                                    <a href="<?=site_url('sos/user/view_profile/'.$tmn->id_teman)?>" style="font-size:small;" class="span12"><?=ucfirst(strtolower((!empty($tmn->nama_pegawai) ? $tmn->nama_pegawai : $tmn->nama_siswa)))?></a>
                                    <span>
                                        <a href="<?=site_url('sos/siswa/hapus_pertemanan/'.$tmn->id_teman)?>">Hapus |</a>
                                        <a href="<?=site_url('sos/siswa/blokir_pertemanan/'.$tmn->id_teman)?>">Blokir</a>
                                    </span>
                                </div>
                            </div>
                        <?php
            ...
            <?php
                if(!empty($permintaan)){
                    ...
                    foreach($permintaan as $pr){
                        if($no==0){
                            echo '<div class="span12 permintaan" style="margin:0px;margin-bottom:10px;">';
                        }
                        if(empty($pr->images)) {
                        ...
                        ?>
                            <div class="span4 datalist_user no_margin">
                                ...
                                <div class="span8 left">
                                    <a style="font-size:smaller;" href="<?=site_url('sos/user/view_profile/'.$pr->id_user)?>" class="span12 nama"><?=(!empty($pr->nama_pegawai) ? $pr->nama_pegawai : $pr->nama_siswa)?></a>
                                    <span>
                                        <a href="<?=site_url('sos/siswa/terima_permintaan/'.$pr->id_user)?>" class="span5 ucapan confirm">Terima |</a> 
                                        <a href="<?=site_url('sos/siswa/tolak/'.$pr->id_user)?>" class="span5 ucapan confirm">Tolak</a>
                                    </span>
                                </div>
                            </div>
                        <?php
                ...
                if(!empty($orang_dikenal['pegawai_dikenal'])) {
                    ...
                    foreach($orang_dikenal['pegawai_dikenal'] as $od){
                        ...
                        $friend .= '<td width="40">
                                    ...
                                    <td>
                                        <a href="'.site_url('sos/user/view_profile/'.$od->id).'" target="_blank" class="user">'.$od->nama.'</a><br>';
                                        if($cek){
                                            $friend.='<span>Menunggu Konfirmasi</span>';
                                        }else{
                                            $friend.='<span><input type="checkbox" name="id_undangan[]" class="id_user_undangan float-left" value="'.$od->id.'"/>&nbsp;<a class="add" id="'.$od->id.'" style="cursor:pointer;">Tambahkan Teman</a></span>';
                                        }    
                        $friend .= '</td>';    
                        $no++;
                        if($no==3){
                        ...
                        $friend .= '<td width="40">
                                    ...
                                    <td>
                                        ...
                                        if($cek_siswa){
                                            ...
                                            $friend.='<span><input type="checkbox" name="id_undangan[]" class="id_user_undangan float-left" value="'.$od->id.'"/>&nbsp;<a class="add" id="'.$od->id.'">Tambahkan Teman</a></span>';
                                        }    
                        $friend .= '</td>';    
                        $no++;
                        if($no==3){
    ...
    <div class="tabs-frame-content" style="display: none;">
        <div class="row-fluid">
            <div class="span12 right">
                <button class="button small lightblue" id="buat_group">Buat Group</button>
                <button class="button small lightblue" id="back_group" style="display: none;">Kembali</button>
            </div>
        </div><br>
            ...
            <?php
                if(!empty($group_anda)) {
                    ...
                    foreach($group_anda as $gr) {
                        ...
                        $no++;
                        if($no==3) {
                            $master_group .= '<div class="span12" style="margin:0px;margin-top:10px;">'.$gr_group.'</div>';
                            $gr_group = '';
                            $no=0;
                        }
                    }
                    if($no<3) {
                        echo $master_group;
                        echo '<div class="span12" style="margin:0px;margin-top:10px;">'.$gr_group.'</div>';
                    }else{
                        echo $master_group;
                    }
                }else{
                    ...
                    foreach($group_diikuti as $ug) {
                        ...
                        $gr_group .= '<div class="span4 datalist_user no_margin">
                                        ...
                                        <div class="span8 left">
                                            ...
                                            $gr_group.='</span>
                                            <span class="span12">
                                                <a href="'.site_url('sos/siswa/keluar_group/'.$ug->id_group).'" class="button small lightblue" style="margin-left:0px;margin-top:5px;">Keluar Group</a>
                                            </span>
                                        </div>
                                    </div>';
                        $no++;
                    ...
                    foreach($undangan_group as $ug) {
                        ...
                        $gr_group .= '<div class="span4 datalist_user no_margin">
                                        ...
                                        <div class="span8 left">
                                            ...
                                            $gr_group.='</span>
                                            <span class="span12">
                                                <a href="'.site_url('sos/siswa/terima_group/'.$ug->id_group).'"> Terima </a>
                                                 | <a href="'.site_url('sos/siswa/tolak_group/'.$ug->id_group).'"> Tolak </a>
                                            </span>
                                        </div>
                                    </div>';
                        $no++;
                    ...
                    if(!empty($teman)) {
                        ...
                        foreach($teman as $tmn) {
                            ...
                            $friend= '<div class="span4 left prev_image">
                                    <input type="checkbox" name="id_undangan[]" class="id_undangan float-left" value="'.$tmn->id_teman.'"/>
