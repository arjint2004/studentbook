...
class Bahanajar extends CI_Controller
    {
        ...
        public function siswa(){
			...
			#$arrdir=$this->ak_file->dirToArray('/home/studoid1/public_html/studentbookgit/upload/contentsekolah/'.$this->session->userdata('ak_setting')['jenjang'][0]['nama'].'/Kelas '.$this->session->userdata('user_authentication')['kelas'].'');
			#$arrdirk13=$this->ak_file->dirToArray('/home/studoid1/public_html/studentbookgit/upload/contentsekolah/k13/'.$this->session->userdata('ak_setting')['jenjang'][0]['nama'].'/Kelas '.$this->session->userdata('user_authentication')['kelas'].'');
        ...
        public function guru($id='',$additional=''){
			...
			#$arrdir=$this->ak_file->dirToArray('/home/studoid1/public_html/studentbookgit/upload/contentsekolah/'.$this->session->userdata('ak_setting')['jenjang'][0]['nama'].'');
			#$arrdirk13=$this->ak_file->dirToArray('/home/studoid1/public_html/studentbookgit/upload/contentsekolah/k13/'.$this->session->userdata('ak_setting')['jenjang'][0]['nama'].'');
