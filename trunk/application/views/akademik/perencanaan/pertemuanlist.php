										...
										$("div#actdellpemp").click(function(){
											...
											if(confirm('Data dan File akan di hapus secara permanen, untuk menggunakannya kembali anda harus upload ulang..')){
												$.ajax({
													type: "POST",
													data: '',
													url: base_url+'akademik/perencanaan/deletepert/'+$(this).attr('id_pemb'),
													beforeSend: function() {
														$(objdell).after("<img id='wait' style='margin:0;float:right;'  src='<?=$this->config->item('images').'loading.png';?>' />");
													},
													success: function(msg) {
							   ...
							   <table>
										...
										<tbody>
											...
											<tr style="cursor:pointer;" title="klik untuk menampilkan / menyembunyikan detail" onclick="$('#detailpertemuan<?=$datapertemuan['id']?>').toggle('fade')">
												...
												<td ><a href="<?=site_url('akademik/perencanaan/addpembelajaran/'.$datapertemuan['id'].'')?>" id="penilaianklik" class="modal">Tambah</a>|<a href="<?=site_url('akademik/perencanaan/pembelajaranlist/'.$datapertemuan['id'].'')?>" id="penilaianklik" class="modal">Lihat</a></td>
												<td ><?=$datapertemuan['pertemuan_ke']?></td>
												<td >
													<div class="actedit modal" href="<?=base_url('akademik/perencanaan/editpertemuan/'.$datapertemuan['id'])?>"></div> 
												...
												<td colspan="7" class="innercolspan">
													...
													<table class="noborder">
														...
														<tr>
															...
															<td class="titikdua">:</td>
															<td class="value"><a href="<?=site_url('akademik/perencanaan/addpembelajaran/')?>" id="penilaianklik" class="modal">Tambah Rpp</a></td>
														</tr>
													</tbody></table>
													</div>
												</td>
