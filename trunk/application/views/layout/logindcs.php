	...
	<div class="container">
		<div class="content content-full-width loginfront">
			<div class="column two-third">
				<h1>SELAMAT DATANG DI DCS TELKOM</h1>
                <p class="desc">
				DIGITAL COLABORATION SCHOOL merupakan sebuah platform digital berbasis internet yang  mengintegrasikan berbagai fungsi pendidikan dan pembelajaran menuju sekolah digital.
				</p>
				<div id="expand-toggle">   
                    <img  title="" alt="" src="<?=site_url()?>asset/default/images/logo-telkom-school.png">
