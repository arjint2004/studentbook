<?php
    $this->load->view('sosial/function');
?>
<script>
    $(function(){
        $(".delete_item").live('click',function(e){
            ...
            if(jwb) {
                window.location.href = '<?=site_url('sos/siswa/hapus_foto_pribadi/')?>/'+id;
            }
        });
    });
</script>
                                    ...
                                    foreach($pesan as $psn){
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="bold_teks"><a href="<?=site_url('sos/siswa/view_profile/'.$psn->penulis)?>"><?=$psn->nama?></a></td>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?=site_url('sos/siswa/view_profile/'.$psn->penulis)?>"><?=$psn->nama?></a></td>
                                ...
                                if(!empty($pesan_keluar)) {
                                    ...
                                    foreach($pesan_keluar as $psn){
                                        echo '<div style="display: none;" class="row-fluid">
                                            ...
                                            <tr>
                                                <td><input type="checkbox" name="pilih[]" value="<?=$psn->id_pesan?>" /></td>
                                                <td><a href="<?=site_url('sos/siswa/view_profile/'.$psn->untuk)?>"><?=$psn->username?></a></td>
                                                <td><a class="modal_dialog lihat_pesan" href="#view_pesan_<?=$psn->id_pesan?>" id="<?=$psn->status." ".$psn->pesan?>"><?=substr($psn->pesan,0,50)?></a></td>
                                                <td><?=$psn->tgl_pesan?></td>
                                                <td><?=$psn->status?></td>
                                            </tr>                            
