																  ...
																  <td class="aspekpenilai"><input type="hidden" name="program[<?=$baris?>][aspek][]" value="<?=$data['aspek'][3]?>"><?=$data['aspek'][3]?></td>
																	...
																	?>
																	  <tr class="sub_2 ncls ncsub2 par_<?=$sub2[0]?> par0_<?=$sub2[0]?>" sub_baris="<?=$sub2[0]?>" baris="<?=$sub2[1]?>">
																		  ...
																		  <td class="nilai"><input type="radio" disabled name="program[<?=$sub2[0]?>][child][<?=$sub2[0]?>_<?=$sub2[1]?>][nilai]" value="<?=$data['aspek'][0]?>" <? if($nilai_2==$data['aspek'][0]){echo 'checked';}?>></td>
																		  <td class="nilai"><input type="radio" disabled name="program[<?=$sub2[0]?>][child][<?=$sub2[0]?>_<?=$sub2[1]?>][nilai]" value="<?=$data['aspek'][1]?>" <? if($nilai_2==$data['aspek'][1]){echo 'checked';}?>></td>
																		  <td class="nilai"><input type="radio" disabled name="program[<?=$sub2[0]?>][child][<?=$sub2[0]?>_<?=$sub2[1]?>][nilai]" value="<?=$data['aspek'][2]?>" <? if($nilai_2==$data['aspek'][2]){echo 'checked';}?> ></td>
																		  <td class="nilai"><input type="radio" disabled name="program[<?=$sub2[0]?>][child][<?=$sub2[0]?>_<?=$sub2[1]?>][nilai]" value="<?=$data['aspek'][3]?>" <? if($nilai_2==$data['aspek'][3]){echo 'checked';}?>></td>
																	  </tr>
																			...
																			?> 
																				<tr class="sub_3 ncsub3 par_<?=$sub3[0]?> par_<?=$sub3[0]?>_<?=$sub3[1]?> ncls" sub_baris="<?=$sub3[0]?>" baris="<?=$sub3[1]?>" baris_sub="<?=$sub3[2]?>">
																					  ...
																					  <td class="nilai"><input type="radio" disabled name="program[<?=$sub3[0]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>_<?=$sub3[2]?>][nilai]" value="<?=$data['aspek'][0]?>"  <? if($nilai_3==$data['aspek'][0]){echo 'checked';}?>></td>
																					  <td class="nilai"><input type="radio" disabled name="program[<?=$sub3[0]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>_<?=$sub3[2]?>][nilai]" value="<?=$data['aspek'][1]?>" <? if($nilai_3==$data['aspek'][1]){echo 'checked';}?>></td>
																					  <td class="nilai"><input type="radio" disabled name="program[<?=$sub3[0]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>_<?=$sub3[2]?>][nilai]" value="<?=$data['aspek'][2]?>" <? if($nilai_3==$data['aspek'][2]){echo 'checked';}?>></td>
																					  <td class="nilai"><input type="radio" disabled name="program[<?=$sub3[0]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>][child][<?=$sub3[0]?>_<?=$sub3[1]?>_<?=$sub3[2]?>][nilai]" value="<?=$data['aspek'][3]?>" <? if($nilai_3==$data['aspek'][3]){echo 'checked';}?>></td>
																				</tr>												
																			<? }  } ?> 
																	<? } } ?> 
															  <? } }?> 
