		...
		<table class="adddata">
			...
			<tr id="jenjang">
				...
				<td>
					...
					<input type="hidden" name="jenjang" value="<?=@$selected['jenjang']?>" />
				</td>
			</tr>
			...
			<tr id="jurusan">
				...
				<td>
					...
					<input type="hidden" name="id_jurusan" value="<?=@$selected['jurusan']?>" />
				</td>
			</tr>
			<? } ?>
			<tr>
				...
				<td>
					...
					<input type="hidden" name="semester" value="<?=@$selected['semester']?>" />
				</td>
			</tr>
