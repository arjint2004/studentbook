...
@font-face {
  ...
  <body><div class="area"></div><nav class="main-menu">
            <ul>
                ...
                <li class="has-subnav">
                    <a href="#">
                        <i class="fa fa-2x"><?=$i?></i>
                        <span class="nav-text">
                            A<input type="radio" name="jawaban[<?=$i?>]" value=""/>
                            B<input type="radio" name="jawaban[<?=$i?>]" value=""/>
                            C<input type="radio" name="jawaban[<?=$i?>]" value=""/>
                            D<input type="radio" name="jawaban[<?=$i?>]" value=""/>
                        </span>
                    </a>
